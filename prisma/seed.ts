    ...
    data: [
      {
        ...
        content:
          '<h2>제목 1</h2><h3>제목 2</h3><h4>제목 3</h4><p>글자</p><p><strong>볼드</strong></p><p>&nbsp;</p><p style="text-align:right;">&nbsp;</p><p style="text-align:right;">정렬</p><p>정렬</p><p style="text-align:center;">정렬</p><p>&nbsp;</p><p><span style="background-color:hsl(0, 75%, 60%);">내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용</span></p><p><span style="background-color:hsl(240, 75%, 60%);">내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용</span></p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p><span style="color:hsl(0, 75%, 60%);">### [회사명] 소개 [회사명]은 최첨단 기술과 탁월한 고객 서비스를 통해 업계를 선도하는 글로벌 통신 회사입니다. 저희 회사는 고객의 다양한 통신 요구를 충족시키기 위해 혁신적인 솔루션과 광범위한 서비스를 제공하고 있습니다. 5G 네트워크, 초고속 인터넷, 안정적인 음성 통화 및 데이터 서비스를 포함하여 고객이 필요로 하는 모든 통신 서비스를 하나의 플랫폼에서 제공합니다. #### 회사 역사 [회사명]은 [설립 연도]에 설립된 이래, 꾸준한 성장과 혁신을 통해 통신 업계에서 확고한 위치를 차지해 왔습니다. 설립 초기부터 저희는 최고의 기술과 서비스 품질을 목표로 삼아, 지속적인 연구개발과 투자를 아끼지 않았습니다. 그 결과, 현재 [회사명]은 글로벌 통신 시장에서 신뢰받는 리더로 자리매김하고 있습니다. #### 핵심 서비스 1. **5G 네트</span><span style="color:hsl(240, 75%, 60%);">워</span><span style="color:hsl(30, 75%, 60%);">크**: [회사명]은 가장 빠르고 안정적인 5G 네트워크를 구축하여 고객에게 초고속 데이터 전송 속도와 최소한의 지연을 제공합니다. 이를 통해 다양한 IoT 기기와 스마트폰 사용자가 원활한 연결을 즐길 수 있습니다. 2. **초고속 인터넷**: 저희의 초고속 인터넷 서비스는 가정과 기업 모두에게 안정적이고 빠른 인터넷 연결을 제공합니다. 다양한 요금제와 맞춤형 솔루션을 통해 고객의 필요에 맞춘 최적의 서비스를 제공합니다. 3. **음성 통화 및 메시징**: [회사명]은 전통적인 음성 통화와 메시징 서비스에서도 최고의 품질을 자랑합니다. 끊김 없는 통화 품질과 다양한 부가 서비스를 통해 고객의 커뮤니케이션을 지원합니다. 4. **클라우드 및 데이터 서비스**: 클라우드 기반의 데이터 저장 및 관리 서비스를 통해 기업 고객이 효율적으로 데이터를 관리하고, 언제 어디서나 안전하게 접근할 수 있도록 돕습니다. #### 고객 서비스 고객 만족은 [회사명]의 최우선 과제입니다. 24시간 고객 지원 센터를 운영하여 고객의 문의와 문제를 신속하게 해결하고 있습니다. 또한, 고객의 피드백을 적극 반영하여 서비스 개선에 최선을 다하고 있습니다. 저희는 고객과의 신뢰를 바탕으로 한 장기적인 관계를 구축하고자 노력합니다. #### 사회적 책임 [회사명]은 기업의 사회적 책임을 다하기 위해 다양한 사회 공헌 활동을 진행하고 있습니다. 친환경 기술 개발, 디지털 격차 해소를 위한 교육 프로그램 지원, 지역 사회와의 협력 등을 통해 지속 가능한 미래를 위한 노력을 아끼지 않습</span><span style="color:hsl(120, 75%, 60%);">니다. #### 미래 비전 [회사명]은 미래의 통신 환경을 선도하기 위해 끊임없는 혁신과 도전을 계속할 것입니다. 차세대 네트워크 기술, 인공지능(AI), 사물인터넷(IoT) 등의 신기술을 활용하여 고객에게 더 나은 통신 경험을 제공할 것입니다. 또한, 글로벌 시장에서의 확장을 통해 전 세계 고객에게 최상의 서비스를 제공하고자 합니다. [회사명]은 언제나 고객과 함께 성장하며, 신뢰받는 통신 파트너로서의 역할을 다할 것입니다. 앞으로도 최고의 기술과 서비스를 통해 고객의 기대를 뛰어넘는 가치를 제공하기 위해 최선을 다하겠습니다.</span></p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><figure class="image"><img style="aspect-ratio:749/750;" src="https://storage.googleapis.com/kg-telecome/posts/image/1721131930743" width="749" height="750"></figure>',
        createdAt: new Date('2024-06-30 14:23:49.082'),
        categoryId: 'INTRO',
      },
      {
        id: 2,
      ...
      },
      {
        ...
        image:
          'https://www.nbnnews.co.kr/news/photo/202212/723416_725481_0009.jpg',
        content:
      ...
      },
      {
        ...
        content:
          '<p>[회사명]은 여러분의 성원에 힘입어 5G 네트워크를 전국으로 확장했습니다. 이를 기념하여, 신규 및 기존 고객 모두에게 특별 할인 혜택을 드리는 이벤트를 마련했습니다. 더욱 빠르고 안정적인 5G 서비스를 더욱 저렴하게 이용하세요!</p><p><strong>이벤트 기간</strong>: 2024년 6월 15일 ~ 2024년 7월 31일</p><p><strong>이벤트 내용</strong>:</p><ul><li>신규 가입 고객: 5G 요금제 첫 2개월 30% 할인</li><li>기존 고객: 5G 요금제 업그레이드 시, 업그레이드 요금 20% 할인</li><li>모든 고객: 이벤트 기간 중 5G 서비스 사용 시, 매주 추첨을 통해 최신 스마트폰 증정</li></ul><p><strong>참여 방법</strong>:</p><ol><li>[회사명] 공식 홈페이지 또는 모바일 앱에서 이벤트 참여 신청</li><li>신규 가입 시, 할인 혜택 자동 적용</li><li>기존 고객은 요금제 업그레이드 시 할인 코드 입력</li></ol><p>5G 네트워크 확대 기념으로 더욱 강력해진 [회사명]의 서비스와 함께 하세요! 지금 바로 신청하고 다양한 혜택을 누리세요!</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><figure class="image"><img src="https://storage.googleapis.com/kg-telecome/posts/image/1720161211676"></figure>',
        createdAt: new Date('2024-06-30 14:23:49.082'),
        categoryId: 'NOTICE',
      },
    ],
    ...
    data: [
      {
        id: 18,
        imageUrl:
          'https://storage.googleapis.com/kg-telecome/banner/popup/1721130359795',
        link: 'https://kg-telecome.web.app/inquiry',
        show: true,
        order: 0,
        position: 'popup',
      },
